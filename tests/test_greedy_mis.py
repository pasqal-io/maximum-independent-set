...
def test_greedy_mis_with_layout_and_blockade(simple_graph, layout_coords):
    config = SolverConfig(
        method=MethodType.GREEDY,
...
def test_quantum_greedy_with_layout(simple_graph, layout_coords):
    config = SolverConfig(
        method=MethodType.GREEDY,
        use_quantum=True,
