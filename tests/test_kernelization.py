...
def test_is_subclique() -> None:
    ...
    test_instance = ker.UnweightedKernelization(SolverConfig(), graph)
...
def test_apply_rule_isolated_node_removal() -> None:
    test_instance = ker.UnweightedKernelization(SolverConfig(), graph_isolated)
...
def test_folding_uw() -> None:
    test_instance = ker.UnweightedKernelization(SolverConfig(), graph_folding)
...
def test_aux_search_confinement() -> None:
    test_instance = ker.UnweightedKernelization(SolverConfig(), P_3)
    ...
    test_instance_2 = ker.UnweightedKernelization(SolverConfig(), CLAW)
...
def test_find_twin() -> None:
    ...
    test_instance2 = ker.UnweightedKernelization(SolverConfig(), K23_CLAW_twin_linked)
...
def test_apply_rule_twin_not_ind() -> None:
    test_instance = ker.UnweightedKernelization(SolverConfig(), K23_CLAW_N_linked)
...
def test_search_rule_twin_reduction() -> None:
    ...
    mis_2 = test_instance.rebuild(set())
    assert mis_2 == {0, 1}
    test_instance_2 = ker.UnweightedKernelization(SolverConfig(), K23_CLAW_N_linked)
